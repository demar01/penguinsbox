...
EN: *The goal of penguinsbox is to supplement the [R for Data Science book](https://r4ds.had.co.nz/) with fading exercises using the penguins and datasets. The package uses these datasets to cover materials of the R4DS and the learnr tutorials.*
