...
En caso de que no consigas instalar `penguinsbox` en tu computadora, por favor escribenos tu [problema aqui](https://github.com/rstudio-education/dsbox/issues) 
...
In case you cannot install `penguinsbox` on your computer, please write us your [problem here](https://github.com/rstudio-education/dsbox/issues) 
...
ES: Todo el material de `penguinsbox` tiene licencia Creative Commons Attribution Share Alike 4.0 International.

EN:  *Note that all materials are released with [Creative Commons Attribution Share Alike 4.0 International](LICENSE.md) license.*
