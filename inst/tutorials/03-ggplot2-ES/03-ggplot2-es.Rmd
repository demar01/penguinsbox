...
Los datos de palmerpenguins contienen medidas del tamaño de atributos de tres especies de pingüinos observadas en tres islas del archipiélago de Palmer, en la Antártida.
...
Comencemos cargando los datos de pingüinos Escribe 'pinguinos' de abajo y selecciona Enviar Respuesta. 
...
Por último, podemos generar un grafico que confirme nuestra hipótesis: los pingüinos son mas pesados que las pingüinas. Para visualizar más claramente este resultado en el gráfico, podemos añadir el valor de la media de masa_corporal al gráfico. 
