...
Por último, podemos generar un grafo que confirme nuestra hipótesis: los pingüinos son mas pesados que las pingüinas. Para visualizar más claramente este resultado en el grafo, podemos añadir el valor de la media de masa_corporal al grafo. 
