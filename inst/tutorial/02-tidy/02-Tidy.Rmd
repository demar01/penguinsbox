...
The goal of this tutorial is to teach you how to recognize tidy data, as well as how to wrangle untidy data to get tidy data using the tidyverse functions pivot_longer and pivot_wider.
